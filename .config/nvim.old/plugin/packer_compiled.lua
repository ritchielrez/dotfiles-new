...
_G.packer_plugins = {
  ...
  ["nvim-colorizer.lua"] = {
    config = { "\27LJ\2\nF\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\3\0\0\6*\t!vim\nsetup\14colorizer\frequire\0" },
    loaded = true,
  ...
  ["nvim-lsputils"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-lsputils",
  ...
  popfix = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/popfix",
    url = "https://github.com/RishabhRD/popfix"
  },
  ["presence.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/presence.nvim",
  ...
  ["vim-mazimizer"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-mazimizer",
